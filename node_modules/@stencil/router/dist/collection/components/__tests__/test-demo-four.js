export class TestDemoFour {
    ...
    render() {
        ...
        return (h("div", null,
            h("a", { href: linkLocation, onClick: (e) => this.handleClick(e, linkLocation) },
                "History push to ",
                linkLocation),
            h("pre", null,
                h("b", null, "this.pages"),
    ...
    static get properties() { return { "history": { "type": "Any", "attr": "history" }, "match": { "type": "Any", "attr": "match" }, "pages": { "type": "Any", "attr": "pages" } }; }
}
